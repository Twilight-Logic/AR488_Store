...
// Teensy 4
#define DIO1  14   /* GPIB 1  */
#define DIO2  15   /* GPIB 2  */
#define DIO3  16   /* GPIB 3  */
#define DIO4  17   /* GPIB 4  */
#define DIO5  18   /* GPIB 13 */
#define DIO6  19   /* GPIB 14 */
#define DIO7  20   /* GPIB 15 */
#define DIO8  21   /* GPIB 16 */

#define IFC   12   /* GPIB 9  */
#define NDAC  11    /* GPIB 8  */
